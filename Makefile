...
7_0_0:
	docker run -it ${REPO} ansible-playbook -e WEBSERVER_INSTANCE_TYPE=r5a.4xlarge -e env=production -e DOCKER_PULL_TAG=7.0.0 -i hosts launch_7.0.0.yml --vault-password-file=.password

7_1_0:
	docker run -it ${REPO} ansible-playbook -e WEBSERVER_INSTANCE_TYPE=r5a.4xlarge -e env=production -e DOCKER_PULL_TAG=7.1.0 -i hosts launch_7.1.0.yml --vault-password-file=.password

7_2_0:
	docker run -it ${REPO} ansible-playbook -e WEBSERVER_INSTANCE_TYPE=r5a.4xlarge -e env=production -e DOCKER_PULL_TAG=7.2.0 -i hosts launch_7.2.0.yml --vault-password-file=.password

7_3_0:
	docker run -it ${REPO} ansible-playbook -e WEBSERVER_INSTANCE_TYPE=r5a.4xlarge -e env=production -e DOCKER_PULL_TAG=7.3.0 -i hosts launch_7.3.0.yml --vault-password-file=.password
...
8_0_0:
	docker run ${REPO} ansible-playbook -e WEBSERVER_INSTANCE_TYPE=r5a.2xlarge -e env=production -e DOCKER_PULL_TAG=8.0.0 -i hosts launch_8.0.0.yml --vault-password-file=.password
...
8_3_0:
	docker run ${REPO} ansible-playbook -e AWS_PRODUCT_TAG=public-website -e AWS_ENV_TAG=production -e WEBSERVER_INSTANCE_TYPE=r5a.2xlarge -e env=production -e DOCKER_PULL_TAG=8.3.0 -i hosts launch_8.3.0.yml --vault-password-file=.password


9_0_0:
	docker run ${REPO} ansible-playbook -e AWS_PRODUCT_TAG=public-website -e AWS_ENV_TAG=production -e WEBSERVER_INSTANCE_TYPE=r5a.2xlarge -e env=production -e DOCKER_PULL_TAG=9.0.0 -i hosts launch_9.0.0.yml --vault-password-file=.password
...
stage_curation_server:
	docker run -it -e PLAYBOOK_NAME="Stage Curation" ${REPO} ansible-playbook -e AWS_PRODUCT_TAG=public-website  -e AWS_ENV_TAG=stage -e env=stage -e SWAP_SIZE=64G -e WEBSERVER_INSTANCE_TYPE=r5a.2xlarge -e SKIP_NVME_DRIVES=true -e START_GOCD_AGENT=true -i hosts custom_playbook_launch_web_instance.yml --vault-password-file=.password
