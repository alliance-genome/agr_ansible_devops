...
4_1_0:
	docker run -it agrlocal/agr_ansible_run_unlocked:${DOCKER_BUILD_TAG} ansible-playbook -e env=production -e DOCKER_PULL_TAG=4.1.0 -i hosts launch_4.1.0.yml --vault-password-file=.password

4_2_0:
	docker run -it agrlocal/agr_ansible_run_unlocked:${DOCKER_BUILD_TAG} ansible-playbook -e env=production -e DOCKER_PULL_TAG=4.2.0 -i hosts launch_4.2.0.yml --vault-password-file=.password

5_0_0:
	docker run -it agrlocal/agr_ansible_run_unlocked:${DOCKER_BUILD_TAG} ansible-playbook -e env=production -e DOCKER_PULL_TAG=5.0.0 -i hosts launch_5.0.0.yml --vault-password-file=.password

5_1_0:
	docker run -it agrlocal/agr_ansible_run_unlocked:${DOCKER_BUILD_TAG} ansible-playbook -e WEBSERVER_INSTANCE_TYPE=r5a.8xlarge -e env=production -e DOCKER_PULL_TAG=5.1.0 -i hosts launch_5.1.0.yml --vault-password-file=.password

5_1_1:
	docker run -it agrlocal/agr_ansible_run_unlocked:${DOCKER_BUILD_TAG} ansible-playbook -e WEBSERVER_INSTANCE_TYPE=r5a.8xlarge -e env=production -e DOCKER_PULL_TAG=5.1.1 -i hosts launch_5.1.1.yml --vault-password-file=.password

5_2_0:
	docker run -it agrlocal/agr_ansible_run_unlocked:${DOCKER_BUILD_TAG} ansible-playbook -e WEBSERVER_INSTANCE_TYPE=r5a.8xlarge -e env=production -e DOCKER_PULL_TAG=5.2.0 -i hosts launch_5.2.0.yml --vault-password-file=.password

5_2_1:
	docker run -it agrlocal/agr_ansible_run_unlocked:${DOCKER_BUILD_TAG} ansible-playbook -e WEBSERVER_INSTANCE_TYPE=r5a.8xlarge -e env=production -e DOCKER_PULL_TAG=5.2.1 -i hosts launch_5.2.1.yml --vault-password-file=.password
...
zfin_jbrowse_process:
	docker run -it -e PLAYBOOK_NAME="Zfin Jbrowse Processor" agrlocal/agr_ansible_run_unlocked:latest ansible-playbook -e START_GOCD_AGENT=false -e DOCKER_PULL_TAG=zfin_latest -e SKIP_NVME_DRIVES=true -e WEBSERVER_INSTANCE_TYPE=m4.xlarge -e env=jbrowse -e jbrowse_env=zfin -i hosts playbook_run_jbrowse_process_gff.yml --vault-password-file=.password
