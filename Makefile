...
8_2_0:
	docker run ${REPO} ansible-playbook -e WEBSERVER_INSTANCE_TYPE=r5a.2xlarge -e env=production -e DOCKER_PULL_TAG=8.2.0 -i hosts releases/launch_8.2.0.yml --vault-password-file=.password
